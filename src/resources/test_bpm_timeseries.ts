...
export const test_time_series = [
	83, 82, 81, 80, 83, 82, 81, 80, 75, 72, 70, 70, 70, 70, 68, 68, 67, 66, 61, 61, 60, 59, 55, 52,
	51, 49, 45, 45, 45, 45, 45, 45, 50, 60, 70, 80
];
/*
export const test_time_series = [
	83, 82, 82, 81, 80, 79, 78, 77, 76, 75, 74, 75, 72, 70, 70, 68, 68, 70, 75, 79, 78, 78, 79, 79,
